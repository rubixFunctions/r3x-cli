...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.r3x_cli.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".r3x_cli" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".r3x_cli")
	}
